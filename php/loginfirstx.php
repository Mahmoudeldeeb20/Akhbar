...
<body>
    ...
    <form action="logfirst.php" method="post">
        <div class="form-div">
            <div class="input-group input-group-lg">
                <input type="tel" name="userid" class="form-control" placeholder="ID" aria-describedby="sizing-addon1" style="border-radius:6px;">
            </div>
            ...
            <div class="alert alert-danger" role="alert">Incorrect ID </div>
        </div>
    </form>
